												...
												<div class="card-content">
													...
													<div class="invoice-product-details mx-md-25">
														<div class="card-body mx-25 py-0" id="Entretien"
															style="display: none;">
															<form action="entretienController" method="POST" id="entretienForm">
																<div class="row">
																	<div class="col-1"></div>
																	<div
																		class="col-10 d-flex align-items-center justify-content-around px-5">
																		<div class="form-group">
																			<label class="form-label" for="date-ent">Date d'entretien</label>
																			<div class="form-control-wrap">
																				<div class="form-icon form-icon-left">
																					<em class="icon ni ni-calendar"></em>
																				</div>
																				<input name="date-ent" type="text" class="form-control date-picker"
																					data-date-format="yyyy-mm-dd" />
																			</div>
																		</div>
																		<div class="form-group">
																			<label class="form-label" for="time-ent">Temps d'entretien</label>
																			<div class="form-control-wrap">
																				<div class="form-icon form-icon-left">
																					<em class="icon ni ni-clock"></em>
																				</div>
																				<input name="time-ent" type="text" class="form-control time-picker"
