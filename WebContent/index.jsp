                ...
                <div class="nk-content ">
                    <div class="nk-block nk-block-middle wide-md mx-auto">
                        <div class="nk-block-content nk-error-ld text-center">
                            <img class="nk-error-gfx" src="<%=request.getContextPath()%>/images/gfx/error-404.svg" alt="">
                            <div class="wide-xs mx-auto">
                                ...
                                <a href="<%=request.getContextPath()%>/login.jsp" class="btn btn-lg btn-primary mt-2">Back To Home</a>
                            </div>
                        </div>
                    </div><!-- .nk-block -->
                </div>
