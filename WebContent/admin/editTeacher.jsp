...
<!-- Page Title  -->
<title>Modifer un enseignant | IPSAS Admin</title>
<!-- StyleSheets  -->
								...
								<div class="components-preview wide-md mx-auto">
									...
									<div class="card">
										<div class="card-inner">
											<div class="card-head">
												<h5 class="card-title">Modifer un Enseignant</h5>
											</div>
												...
												<div class="row g-3">
													<div class="col-lg-7 offset-lg-5">
														<div class="form-group mt-2">
															<button type="submit" class="btn btn-lg btn-primary">Mise à jour</button>
														</div>
													</div>
												</div>
											</form>
