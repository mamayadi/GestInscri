			...
			<div class="nk-header-tools">
				<ul class="nk-quick-nav">
						...
						class="dropdown-toggle" data-toggle="dropdown">
							<div class="user-toggle">
								...
								<div class="user-info d-none d-md-block">
									<c:if test="${connectedUser != null }">
										<div class="user-status">${connectedUser.getRole() }</div>
										<div class="user-name dropdown-indicator">
											${connectedUser.getMail() }</div>
									</c:if>
								</div>
							</div>
					</a>
							...
							<div
								...
								<div class="user-card">
									<div class="user-avatar">
										<c:if test="${connectedUser != null }">
											<span>${connectedUser.getProfilImageText() }</span>
										</c:if>
									</div>
									<div class="user-info">
										<c:if test="${connectedUser != null }">
											<span class="lead-text">${connectedUser.getFullName() }</span>
											<span class="sub-text">${connectedUser.getMail() }</span>
										</c:if>
									</div>
								</div>
							</div>
					...
					<li class="dropdown notification-dropdown mr-n1"><a href="#"
						class="dropdown-toggle nk-quick-nav-icon" data-toggle="dropdown">
