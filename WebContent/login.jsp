                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            <a href="html/index.html" class="logo-link">
                                <img class="logo-light logo-img logo-img-lg" src="<%=request.getContextPath()%>/images/ipsas/logo.png" srcset="<%=request.getContextPath()%>/images/ipsas/logo2x.png 2x" alt="logo">
                                <img class="logo-dark logo-img logo-img-lg" src="<%=request.getContextPath()%>/images/ipsas/logo-dark.png" srcset="<%=request.getContextPath()%>/images/ipsas/logo-dark2x.png 2x" alt="logo-dark">
                            </a>
                        </div>
                        <div class="card">
                            <div class="card-inner card-inner-lg">
                                ...
                                <div class="form-note-s2 text-center pt-4"> New on our platform? <a href="<%=request.getContextPath()%>/register.jsp">Create an account</a>
                                </div>
